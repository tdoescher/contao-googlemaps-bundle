...
$GLOBALS['TL_DCA']['tl_content']['palettes']['google_maps_embed'] = '{type_legend},type,headline;{googlemaps_legend},googlemaps_apikey,googlemaps_zoom,googlemaps_address;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
$GLOBALS['TL_DCA']['tl_content']['palettes']['google_maps_html'] = '{type_legend},type,headline;{googlemaps_legend},html;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
